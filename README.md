...
## Project Overview
Project created to show the basic understanding of Postman, based on Restful-Booker API testing.
---
...
Restful_Booker_API_Testing/
  Postman/
    ...
    Restful_Booker_Environment.postman_environment.json
    Restful_Booker_Environment_RandomValues.postman_environment.json
README.md
